const scriptMappings = {
  '918765cae1147f5f2d914d45059f8b6497caa149ea94dd8da1f683ce': 'indigosp',
  '54e8d424816f5bbd423353009ff7c31ada2cbdefe651175014117f46': 'indigostaking',
  'fd0d72fafee1d230a74c31ac503a192abd5b71888ae3f94128c1e634': 'indigostaking',
  'a23793f529179e09cefb3c37fc6ae081e0e99e99be5cdb55a00941a5': 'indigostaking',
  '8110c6ae9c92962f01ce98611656c05ea69aa5a709f4ea89c588bbdb': 'indigostaking',
  'a473cb8eb0b61c03b8696fceab1c1a89fa3ec834572850e7c2abe783': 'indigosp',
  'de1585e046f16fdf79767300233c1affbe9d30340656acfde45e9142': 'indigocdp',
  '443c51db609bba8b2aa4c8af248bf797cbfcfa1e413c443296a50813': 'indigosp',
  'c1af46643698bc73f9857a0cc21ec949ce6919974b435d057dc448b8': 'indigosp', // indigo pool
  'e4d2fb0b8d275852103fd75801e2c7dcf6ed3e276c74cabadbe5b8b6': 'indigocdp', // indigo cdp addflouz
  'ea5358d9fe82cc7ad8de0e76b4eabd851526408e51daa9d8bb4b137d': 'indigocdp', // indigo cdp creator
  '708f5e6d597fc038d09a738d7be32edd6ea779d6feb32a53668d9050': 'indigocdp', // indigo (CDP ? )poll manager
  'f66d78b4a3cb3d37afa0ec36461e51ecbde00f26c8f0a68f94b69880': 'indigocdp', // indigo cdp
  '131f26cd99012663aa063d0ef86dc0ac039d1797d5e062768fb12e74': 'indigopoll', // indigo poll manager
  '16c0a490c721920096645c5594499b2cb1d4067566a9e85855b9326c': 'indigopoll', // indigo poll manager
  '31aaab10e57345a2ed5c37ca32c57b2d9dc6219d23b51c85919febe2': 'indigopoll', // indigo poll manager
  '0d8aee2011f769502cdc07273f7e118722ebf9c585f3fee061986b7b': 'indigocdp', // indigo close cdp (?)
  'd8fba96a5ebeeaee104a5b6c9e9265fff0ad7af8c64698c7364157f0': 'indigocdp', // indigo cdp
  '0752abd65a0c983bfb1c9c3880cc632c099ba3adb2fe307afb4bbd9c': 'indigocdp', // indigo cdp (creation?)
  '9a5c575d3bf99604bcb691d5f000b4b41866edb893b35a718be5dd01': 'indigocdp', // indigo cdp (creation?)
  ...
  '9b85d5e8611945505f078aeededcbed1d6ca11053f61e3f9d999fe44': 'minswap', // Staking Contract
  '98df3b00a1500fcb77daa0520550fb088fc923399788b89637b9de59': 'minswap', // Harvest Contract
  '229863ae8694da16da002e889a1d19bcc82c581225b6dcca95fd69da': 'minswap', // Minswap (Min staking)
  ...
  '4dd522fb07d1f895ee63270b040e8b6434aa848a9c48ee16a7903aad': 'fluid', // Fluid Tokens (repayments) 
  '74f5a268f20a464b086baca44fd4ac4e2dc3c54914e4f1d9212c3f02': 'fluid', // Fluid Tokens (loan requests)
